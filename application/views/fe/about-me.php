...
<html class="no-js" lang="en">
    <head>
        <title>Nauti T's Creation | About Us</title>
        <meta charset="utf-8">
        ...
        <style>
            ...
            #where-to ul li:before {
                content: url('assets/images/ul-icon.png');                
    ...
    <body data-mobile-nav-style="classic">
        ...
        <!-- end header -->
        <!-- start page title -->
        <section id="about" class="overlap-height wow animate__fadeIn padding-60px-bottom parallax" data-parallax-background-ratio="0.5" style="background-image:url('<?php echo base_url('assets/images/our-story-bg.jpg');?>');" >
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-12 col-xl-8 col-lg-10 text-center overlap-gap-section">
                        ...
                        <h3 class="alt-font font-weight-500 text-extra-dark-gray letter-spacing-minus-1px">We focus on producing creations with top <span class="text-gradient-orange-pink font-weight-600">quality fresh ingredients</span>, no additives or preservatives and  <span class="text-gradient-orange-pink font-weight-600">hand crafted perfect delights</span></h3>
                    </div>
                </div>
            </div>
        </section>
                    ...
                    <div class="col col-sm-8 text-center process-step-style-04 sm-margin-6-rem-bottom wow animate__fadeIn" data-wow-delay="0.2s">
                        <div class="process-step-item">
                            ...
                            <div class="process-step-item-box">
                                ...
                                <div class="process-content last-paragraph-no-margin">
                                    <span class="alt-font d-block font-weight-500 text-white margin-10px-bottom">Hand Crafted</span>
                                    <p class="text-white opacity-7">Our creations are all Handcrafted in small batches to give them their own individual personality and character</p>
                                </div>                        
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col col-sm-8 text-center process-step-style-04 wow animate__fadeIn" data-wow-delay="0.4s">
                        <div class="process-step-item">
                            ...
                            <div class="process-step-item-box">
                                ...
                                <div class="process-content last-paragraph-no-margin">
                                    <span class="alt-font d-block font-weight-500 text-white margin-10px-bottom">Project Topping</span>
                                    <p class="text-white opacity-7">Our creations are also used for dessert toppings, meat marinades, sauces, glazes to add that special "pop" on beverages and not just on toast</p>
                                </div>                        
                            </div>
                        </div>
                    </div>
        ...
        <!-- end section -->
        <!-- start section -->
        <section class="overflow-visible wow animate__fadeIn bg-gradient-fast-blue-purple" id='where-to'>
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-12 col-lg-6 margin-70px-top lg-margin-30px-top md-margin-50px-bottom wow animate__fadeIn" data-wow-delay="0.2s">
                        ...
                        <div class="position-absolute right-15px bottom-0px w-70" data-parallax-layout-ratio="1.1">
                            <img class="border-radius-6px" src="<?php echo base_url('assets/images/about-local-store1.png');?>" alt="" />
                        </div>
                    </div>
                    <div class="col-12 col-lg-5 offset-lg-1 wow animate__fadeIn" data-wow-delay="0.4s">
                        <div class="alt-font text-extra-medium font-weight-500 margin-30px-bottom media">
                            <div class="media-body"><span class="text-gradient-sky-blue-pink title-small">Where to find in Local Store?</span></div>
                        </div>
                        <div class="">
                            <ul class="text-white text-extra-medium">
                            <?php
                                foreach ($LocalStores as $Store)
                                    echo '<li>'. $Store['Value'] . '</li>';
                            ?>                            
                            </ul>
                        </div>
                    </div>
        ...
        <section class="bg-light-gray wow animate__fadeIn">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-12 col-md-6 text-center margin-4-half-rem-bottom">                        
                        <h5 class="alt-font text-extra-dark-gray font-weight-500 letter-spacing-minus-1px">Ingredient Resources</h5>
                    </div>
                </div>
                            ...
                            <div class="swiper-container padding-15px-all black-move" data-slider-options='{ "loop": false, "slidesPerView": 1, "spaceBetween": 30, "observer": true, "observeParents": true, "navigation": { "nextEl": ".swiper-button-next-nav-4", "prevEl": ".swiper-button-previous-nav-4" }, "keyboard": { "enabled": true, "onlyInViewport": true }, "autoplay": { "delay": 3000, "disableOnInteraction": false },  "breakpoints": { "992": { "slidesPerView": 3 }, "768": { "slidesPerView": 2 } }, "effect": "slide" }'>
                                ...
                                <?php
                                    ...
                                    <div class="swiper-slide">
                                        <!-- start services item -->
                                        <div class="bg-white box-shadow-small md-margin-30px-bottom xs-margin-15px-bottom wow animate__fadeIn">
                                            <div style="background-image: url('<?php echo base_url('assets/images/ingredients/'.$resource['Attach']);?>'); min-height: 240px; background-size: cover;">
                                            </div>                                            
                                            <div class="padding-3-rem-all">
                                                <span class="text-extra-dark-gray alt-font d-block font-weight-500 margin-10px-bottom"><?php echo $resource['Title'];?></span>
                                            </div>
                                        </div>
                                        <!-- end services item -->
                                    </div>
        ...
        <!-- end section -->
        <!-- start section -->
        <section class="padding-eight-tb cover-background parallax xs-padding-50px-tb wow animate__fadeIn" data-parallax-background-ratio="0.5" style="background-image:url('<?php echo base_url('assets/images/about_partner.jpg');?>');">
            <div class="opacity-medium bg-gradient-fast-blue-purple"></div>
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-12 col-xl-7 col-lg-8 col-md-10 text-center">
                        <h3 class="alt-font text-white font-weight-600 margin-35px-bottom">Nauti T's Gives Back to Frontline Workers During Covid/HEB 396 Partners</h3>
                        <p class="text-white opacity-7 alt-font text-large w-80 mx-auto line-height-32px margin-45px-bottom sm-w-100">During the Covid pandemic, Nauti T's gave everything they had to show our frontline workers at our local HEB in Flour Bluff how much we apperciated them!<br /><br /> We gave a jar of jelly, a bag with 3 cookies, and a personalized Thank You note! <br /><br />That was 396 jars of jelly and 1200 cookies baked. We love our community and wanted all the partners to know how much we truly appreciated them!!!</p>
                        <a href="https://www.youtube.com/watch?v=SVyobvYPa1c" class="popup-youtube btn btn-large btn-white btn-rounded btn-box-shadow">Show Video</a>
                    </div>
                </div>
            </div>
        </section>
