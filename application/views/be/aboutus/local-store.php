...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Philotechnics | About Us</title>
    ...
    <body class="page-container-bg-solid page-boxed">     
                                    ...
                                    <div class="portlet light form-fit ">
                                        <div class="portlet-title">
                                            <div class="caption">
                                                ...
                                                <span class="caption-subject font-green bold uppercase">Local Store Content</span>
                                            </div>                                         
                                        </div>
                                            ...
                                            <form action="#" class="form-horizontal form-bordered ">
                                                <div class="form-body">
                                                    <div class="form-group">
                                                        <label class="control-label col-md-3">Our Stores</label>
                                                        <div class="col-md-9">
                                                                ...
                                                                foreach ($LocalStores as $store) {
                                                                    ?>
                                                                        <div class='core-value'>                                                                
                                                                            <span><?php echo $store['Value'];?></span>
                                                                            <div class='core-value-buttons'>                                                                    
                                                                                <button type="button" class="btn blue btn-sm btn-circle" onclick='editValue(<?php echo $store["ID"];?>)'><i class='icon-pencil'></i></button>&nbsp;
                                                                                <button type="button" class="btn red btn-sm btn-circle" onclick='deleteValue(<?php echo $store["ID"];?>)'><i class='icon-trash'></i></button>
                                                                            </div>
                                                                        </div>
                                                                    <?php
                                                                }
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="" class="form-horizontal form-bordered" id='addNewForm'>
                                    <div class="form-body">
                                        <div class="form-group">
                                            <label class="control-label col-md-3">Store Location</label>
                                            <div class="col-md-9">
        ...
        <script src="<?php echo base_url('assets/layouts/layout3/scripts/pages/aboutus/local-store.js');?>" type="text/javascript"></script>
