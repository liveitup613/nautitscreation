...
<html lang="en">
    ...
    <body class="page-container-bg-solid page-boxed">     
            ...
            <div class="page-content-wrapper">
                                    ...
                                    <div class="portlet light form-fit ">
                                        <div class="portlet-title">
                                            <div class="caption">
                                                ...
                                                <span class="caption-subject font-green bold uppercase">Photos Content</span>
                                            </div>                                         
                                        </div>
                ...
                <div class="modal fade" id="AddNewModal" tabindex="-1" role="basic" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content" id="addPhotoModalContent">
        ...
        <script src="<?php echo base_url('assets/layouts/layout3/scripts/pages/media/photos.js');?>" type="text/javascript"></script>
