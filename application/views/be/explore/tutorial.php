...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Nauti T's Creation Admin | Turtorial</title>
    ...
    <body class="page-container-bg-solid page-boxed">     
                                    ...
                                    <div class="portlet light form-fit ">
                                        <div class="portlet-title">
                                            <div class="caption">
                                                ...
                                                <span class="caption-subject font-green bold uppercase">Tutorial Content</span>
                                            </div>                                         
                                        </div>
        ...
        <script src="<?php echo base_url('assets/layouts/layout3/scripts/pages/explore/tutorial.js');?>" type="text/javascript"></script>
