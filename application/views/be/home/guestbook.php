...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Nauti T's Creation Admin | Home</title>
        ...
        <link rel="shortcut icon" href="<?php echo base_url('favicon.svg');?>" /> </head>
     </head>
    <!-- END HEAD -->
    ...
    <body class="page-container-bg-solid page-boxed">     
                                    ...
                                    <div class="portlet light form-fit ">
                                        <div class="portlet-title">
                                            <div class="caption">
                                                ...
                                                <span class="caption-subject font-green bold uppercase">GuestBooks Content</span>
                                            </div>                                         
                                        </div>
                                            ...
                                            <form action="#" class="form-horizontal form-bordered ">
                                                <div class="form-body">
                                                    <div class="form-group">
                                                        <label class="control-label col-md-3">Our GuestBooks</label>
                                                        <div class="col-md-9">
                                                                ...
                                                                foreach ($guestbooks as $guestbook) {
                                                                    ?>
                                                                        <div class='core-value'>                                                                
                                                                            <span><?php echo $guestbook['Client'];?></span>
                                                                            <div class='core-value-buttons'>                                                                    
                                                                                <button type="button" class="btn blue btn-sm btn-circle" onclick='editValue(<?php echo $guestbook["ID"];?>)'><i class='icon-pencil'></i></button>&nbsp;
                                                                                <button type="button" class="btn red btn-sm btn-circle" onclick='deleteValue(<?php echo $guestbook["ID"];?>)'><i class='icon-trash'></i></button>
                                                                            </div>
                                                                        </div>
                                                                    <?php
                                                                }
                                ...
                                <form action="" class="form-horizontal form-bordered" id='addNewForm'>
                                    <div class="form-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <textarea type='text' id='Client' class='form-control'></textarea>
                                            </div>
                                        </div> 
                                        <div class="form-group">
                                            <label class="control-label col-md-3">Feedback</label>
                                            <div class="col-md-9">
                                                <textarea type='text' id='Feedback' class='form-control' rows='5'></textarea>
                                            </div>
                                        </div>                                        
                                    </div>                                    
                                </form>
                                ...
                                <form action="" class="form-horizontal form-bordered" id='addNewForm'>
                                    <div class="form-body">
                                        <div class="form-group">
                                            <label class="control-label col-md-3">Client</label>
                                            <div class="col-md-9">
                                                <textarea type='text' id='ClientEdit' class='form-control'></textarea>
                                            </div>
                                        </div> 
                                        <div class="form-group">
                                            <label class="control-label col-md-3">Feedback</label>
                                            <div class="col-md-9">
                                                <textarea id='FeedbackEdit' class='form-control' rows='5'></textarea>
                                            </div>
                                        </div>                                        
                                    </div>                                    
                                </form>
        ...
        <script src="<?php echo base_url('assets/layouts/layout3/scripts/pages/home/guestbook.js');?>" type="text/javascript"></script>
