...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Nauti T's Creation Admin | FAQ</title>
    ...
    <body class="page-container-bg-solid page-boxed">     
                                    ...
                                    <div class="portlet light form-fit ">
                                        <div class="portlet-title">
                                            <div class="caption">
                                                ...
                                                <span class="caption-subject font-green bold uppercase">Content</span>
                                            </div>                                         
                                        </div>
                                            ...
                                            <form action="#" class="form-horizontal form-bordered ">
                                                <div class="form-body">
                                                    <div class="form-group">
                                                        <label class="control-label col-md-3">FAQs</label>
                                                        <div class="col-md-9">
                                                                    ...
                                                                    ?>
                                                                        <div class='core-value'>                                                                
                                                                            ...
                                                                            <div class='core-value-buttons'>                                                                    
                                                                                <button type="button" class="btn blue btn-sm btn-circle" onclick='editValue(<?php echo $row["ID"];?>)'><i class='icon-pencil'></i></button>&nbsp;
                                                                                <button type="button" class="btn red btn-sm btn-circle" onclick='deleteValue(<?php echo $row["ID"];?>)'><i class='icon-trash'></i></button>
                                                                            </div>
                                                                        </div>
                                                                    <?php
                                                                }
                                ...
                                <form action="" class="form-horizontal form-bordered" id='addNewForm'>
                                    <div class="form-body">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-md-3">Answer</label>
                                            <div class="col-md-9">
                                                <textarea id='ValueEdit' class='form-control' rows='5'></textarea>
                                            </div>
                                        </div>                                        
                                    </div>                                    
                                </form>
        ...
        <script src="<?php echo base_url('assets/layouts/layout3/scripts/pages/faq/index.js');?>" type="text/javascript"></script>
