...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Nauti T's Creation Admin | Contact Us</title>
                                            ...
                                            <form action="#" class="form-horizontal form-bordered ">
                                                <div class="form-body">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            <input type="text" class='form-control' id='Location' value="<?php echo $Contact[0]['Value'];?>">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class='control-label col-md-3'>Phone</label>                                                      
                                                        <div class="col-md-9">
                                                            <input type="text" class='form-control' id='Phone' value="<?php echo $Contact[1]['Value']; ;?>">
                                                        </div>
                                                    </div>                                                    
                                                    <div class="form-group">
                                                        <label class='control-label col-md-3'>Email</label>                                                      
                                                        <div class="col-md-9">
                                                            <input type="text" class='form-control' id='Email' value="<?php echo $Contact[2]['Value'];;?>">
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="portlet light form-fit ">
                                        <div class="portlet-title">
                                            <div class="caption">
                                                <i class="icon-social-dribbble font-green"></i>
                                                <span class="caption-subject font-green bold uppercase">Hour Content</span>
                                            </div>                                         
                                        </div>
                                        <div class="portlet-body form">
                                            <!-- BEGIN FORM-->
                                                            ...
                                                            <?php 
                                                                foreach ($Hour as $hour) {
                                                                    ?>
                                                                        ...
                                                                        <span><?php echo $hour['Name'];?></span><span><?php echo $hour['Value'];?></span>
                                                                            <div class='core-value-buttons'>                                                                    
                                                                                <button type="button" class="btn blue btn-sm btn-circle" onclick='editValue(<?php echo $hour["ID"];?>)'><i class='icon-pencil'></i></button>&nbsp;
                                                                                <button type="button" class="btn red btn-sm btn-circle" onclick='deleteValue(<?php echo $hour["ID"];?>)'><i class='icon-trash'></i></button>
                                                                            </div>
                                                                        </div>
                                                                    <?php
                                                                }
                            ...
                            <div class="modal-body">
                                <form action="" class="form-horizontal form-bordered" id='addNewForm'>
                                    <div class="form-body">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-md-3">Time Duration</label>
                                            <div class="col-md-9">
                                ...
                                <form action="" class="form-horizontal form-bordered" id='addNewForm'>
                                    <div class="form-body">
                                        <div class="form-group">
                                            <label class="control-label col-md-3">Date</label>
                                            <div class="col-md-9">
                                                <textarea id='NameEdit' class='form-control'></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-md-3">Time Duration</label>
